...
export default function EntitiesScreen() {
  ...
  const renderRightActions = useCallback((entityId) => (
    <View style={{ flexDirection: 'row' }}>
      <TouchableOpacity
        style={[styles.actionBtnEdit, { backgroundColor: colors.primary }]}
        onPress={() => navigate(ROUTES.ADD_ENTITY, { editEntityId: entityId })}
      ...
      <TouchableOpacity
        style={[styles.actionBtnDelete, { backgroundColor: colors.danger }]}
